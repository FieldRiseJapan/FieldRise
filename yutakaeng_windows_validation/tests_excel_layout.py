...
from pipeline import WireRow, write_excel
...
with tempfile.TemporaryDirectory() as temp_dir:
    ...
    rows = [
        WireRow(1, "P1-F1", "YF", "マルチコネクター", "1", "FL1A11", "L-A", "R-Y2", ["Y2"], "未確認", "", "", ""),
    ...
    check([worksheet.cell(6, column).value for column in range(1, 8)], ["FL1A11", 2, "未確認", "未確認", "L-A", "R-Y2", "Y2"], "verified wire mark count is two")
